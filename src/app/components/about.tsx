...
const About = () => {
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row-reverse flex-col items-center">
    ...
    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center pr-7">
      ...
      <p className="mb-8 leading-relaxed line-clamp-2">
      ...
      <div className="flex justify-center">
        ...
        <button className="inline-flex items-center gap-x-2 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
